                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label-sm text-md-right">{{ __('Nombre') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label-sm text-md-right">{{ __('Correo electrónico') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label-sm text-md-right">{{ __('Contraseña') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label-sm text-md-right">{{ __('Confirmar contraseña') }}</label>
